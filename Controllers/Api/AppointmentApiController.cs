...
namespace AppointmentScheduler.Controllers.Api
{
    ...
    public class AppointmentApiController : Controller
    {
        ...
        public IActionResult GetCalendarData(string therapistId)
        {
            ...
            try
            {
                ...
                else if (role == Helper.Therapist)
                {
                    commonResponse.dataenum = _appointmentService.TherapistsEventsById(loginUserId);
                    commonResponse.status = Helper.success_code;
                }
                else
                {
                    commonResponse.dataenum = _appointmentService.TherapistsEventsById(therapistId);
                    commonResponse.status = Helper.success_code;
                }
            }
            catch (Exception e)
